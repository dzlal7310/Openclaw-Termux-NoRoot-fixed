# 🤖 OpenClaw Termux No Root — Fixed

**Control any Android phone via Telegram using Gemini AI — no root required.**

This is a patched version of [jarvesusaram99/Openclaw-Termux-NoRoot](https://github.com/jarvesusaram99/Openclaw-Termux-NoRoot) that fixes the following known errors:
...
- 🐛 **Fixes** — Automatically repairs missing npm dependencies
...
```bash
curl -sL https://raw.githubusercontent.com/dzlal7310/Openclaw-Termux-NoRoot-fixed/main/auto_setup.sh | bash
```
...
| Problem | Solution |
|---|---|
| `Cannot find module '@buape/carbon'` | Run: `cd $(npm root -g)/openclaw && npm install @buape/carbon` |
| `Cannot find module '@slack/web-api'` | Run: `cd $(npm root -g)/openclaw && npm install @slack/web-api` |
...
- **[Openclaw-Termux-NoRoot](https://github.com/jarvesusaram99/Openclaw-Termux-NoRoot)** by [jarvesusaram99](https://github.com/jarvesusaram99) — Original installer this project is based on.
