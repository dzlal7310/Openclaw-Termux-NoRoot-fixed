...
# ========================================================================
# CloudBot + Shizuku safer installer (trimmed)
# ========================================================================
...
echo ""
echo "CloudBot safer setup (trimmed)"
echo "============================================================"
echo ""

# ========================================================================
# Step 1/3: Update packages and install dependencies
# ========================================================================
echo "[1/3] Updating packages and installing dependencies..."
...
# ========================================================================
# Step 2/3: Setup Shizuku terminal helper scripts (rish, shizuku)
# ========================================================================
echo ""
echo "[2/3] Linking Shizuku to Termux..."
...
# ========================================================================
# Step 3/3: Apply Node.js IPv4 DNS fix for Termux
# ========================================================================
echo ""
echo "[3/3] Applying Node.js IPv4 DNS fix..."
